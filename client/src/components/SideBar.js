...
import { initialState, useNav } from './customHooks/useNav';


export default function SideBar() {
    //TODOD need to implement currnet tab function 
    const nav = useNavigate();
    const { data, initial } = useContext(HeaderContext);
    // const [nv,setNv] = useNav("nav");
    ...
    const user = {
        ...
        icon: <Avatar sx={{ bgcolor: "#4F46E5" }}>{initial}</Avatar>
    ...
    return (
        <>
            {/*
                ...
                ```
              */}
            <div id="header" className="min-h-full">
